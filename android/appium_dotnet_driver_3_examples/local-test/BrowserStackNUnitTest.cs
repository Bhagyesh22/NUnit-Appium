...
namespace android.local
{
	public class BrowserStackNUnitTest
	{
		...
		public void Init()
		{
			...
			// if the platform is Windows, enable local testing from within the test
					...
					&& capability.GetCapability("browserstack.local").ToString() == "true")
			{
				...
				new KeyValuePair<string, string>("binarypath", "/Users/bhagyesh/Downloads/BrowserStackLocal")
				};
					browserStackLocal.start(bsLocalArgs);
				}
